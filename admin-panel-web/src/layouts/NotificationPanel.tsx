...
export function NotificationPanel({ data, setData, onClose }: NotificationPanelProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 top-11 z-40 w-80 rounded-xl border border-border bg-card shadow-2xl"
    >
          ...
          data.map((n, idx) => (
            <div key={n.id}>
              ...
              <button
                ...
                className={`flex w-full items-start gap-3 px-4 py-3 text-left cursor-pointer hover:bg-surface-alt/60 ${
