      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="relative">
          <button
            ...
            className="relative flex h-9 w-9 items-center justify-center rounded-lg text-ink-secondary hover:bg-surface-alt cursor-pointer"
          >
        ...
        <div className="mx-2 flex items-center gap-2.5 border-l border-border pl-3">
          ...
          <button
            onClick={signOut}
            className="ml-1 flex h-9 w-9 items-center justify-center rounded-lg text-ink-secondary hover:bg-danger-bg hover:text-danger cursor-pointer"
            title="Log out"
          >
